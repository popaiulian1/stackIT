...
{
	return PieceUtils::mPieces[pPiece][pRotation][pX][pY];
}

// Returns the X displacement of the piece
int Pieces::GetXInitialPosition(int pPiece, int pRotation)
{
	return PieceUtils::mPiecesInitialPositions[pPiece][pRotation][0];
}

// Returns the Y displacement of the piece
int Pieces::GetYInitialPosition(int pPiece, int pRotation)
{
	return PieceUtils::mPiecesInitialPositions[pPiece][pRotation][1];
}
